  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Why AlphaDAO Foundation Exists"}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="md:col-span-2">
              ...
              <h3 className="text-2xl font-bold mb-3">{"The AlphaDAO Foundation Solution"}</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="p-6">
                  <h4 className="font-bold mb-2">{"Long-Term Aligned Capital"}</h4>
                ...
                <Card className="p-6">
                  <h4 className="font-bold mb-2">{"Builder-First Funding"}</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    {
                ...
                <Card className="p-6">
                  <h4 className="font-bold mb-2">{"Transparent Allocation"}</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    {
                ...
                <Card className="p-6">
                  <h4 className="font-bold mb-2">{"DAO-Aligned Incentives"}</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    {
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Foundation Mandate"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Fund Early-Stage Builders & Teams"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Support Public Goods & Infrastructure"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Back AlphaDAO Labs Products"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Grow the AlphaDAO Ecosystem Sustainably"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Preserve Treasury Longevity"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6">
              ...
              <h3 className="text-lg font-bold mb-2">{"Foster Collaborative Ecosystems"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Capital Allocation Strategy"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <Card className="p-8 border-2 hover:border-primary transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold">{"Product-Backed Ventures"}</h3>
            ...
            <Card className="p-8 border-2 hover:border-primary transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold">{"Ecosystem Startups"}</h3>
            ...
            <Card className="p-8 border-2 hover:border-primary transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold">{"Public Goods & Research"}</h3>
            ...
            <Card className="p-8 border-2 hover:border-primary transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold">{"Grants & Bounties"}</h3>
            ...
            <Card className="p-8 border-2 hover:border-primary transition-colors">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-2xl font-bold">{"Strategic Reserves"}</h3>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="p-8 rounded-xl border-2 border-primary/20 bg-primary/5">
              <p className="text-lg font-semibold text-center text-balance">
                {
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Investment & Funding Models"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Grants (Non-Dilutive)"}</h3>
              ...
              <p className="text-sm text-muted-foreground italic">{"Typical range: $5k - $50k"}</p>
            </Card>
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Revenue Share Agreements"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
              ...
              <p className="text-sm text-muted-foreground italic">{"Example: 5-15% revenue share until 3x return"}</p>
            </Card>
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Strategic Equity (Where Applicable)"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
              ...
              <p className="text-sm text-muted-foreground italic">{"Typical range: 5-20% equity"}</p>
            </Card>
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Token Warrants (Future, Optional)"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
              ...
              <p className="text-sm text-muted-foreground italic">{"Evaluated case-by-case"}</p>
            </Card>
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Milestone-Based Funding"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
              ...
              <p className="text-sm text-muted-foreground italic">{"Standard for all investments >$50k"}</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Investment Focus Areas"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">{"Web3 Infrastructure"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">{"DAO Tooling & Governance"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">{"Identity & Reputation Systems"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-6 border-2 hover:border-primary transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">{"Emerging Market Talent"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Governance & Oversight"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Founder-Led Stewardship (Early Phase)"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
            ...
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Advisory Review Council"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
            ...
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Community Signaling (Snapshot)"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Application & Evaluation Process"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
      ...
      <section className="border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Reporting & Accountability"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Public Funding Disclosures"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Milestone Updates"}</h3>
              <p className="text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Ecosystem Impact Reporting"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
            ...
            <Card className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{"Treasury Transparency (When Applicable)"}</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                {
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="max-w-7xl mx-auto px-6 py-24 lg:py-32">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight mb-6">{"Relationship to AlphaDAO"}</h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              {
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Foundation Operates Independently"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
            ...
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Aligned with AlphaDAO Mission"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
            ...
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Supports Labs and Bootcamp"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
            ...
            <Card className="p-8">
              <h3 className="text-2xl font-bold mb-4">{"Protects Long-Term Sustainability"}</h3>
              <p className="text-muted-foreground leading-relaxed mb-4">
                {
